...
class BlogPost(db.Model):
    ...
    blog_comments = relationship('Comments', back_populates='parent_post')
...
def login():
    ...
    if form.validate_on_submit():
        ...
        if user:
            ...
            flash("This email don't exist, please try again")
            return render_template("login.html", form=form)
...
def show_post(post_id):
    ...
    # comments = [comments.body for comments in requested_post.blog_comments]
